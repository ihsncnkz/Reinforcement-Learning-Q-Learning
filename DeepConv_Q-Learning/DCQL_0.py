...
def drawBall(ballXPos, ballYPos):
    ...
    ball = pygame.Rect(ballXPos, ballYPos, BALL_WIDHT, BALL_HEIGHT)
...
def updateBall(paddle1YPos, paddle2YPos, ballXPos, ballYPos, ballXDirection, ballYDirection, DeltaFrameTime):
    ...
    elif (ballXPos >= WINDOW_WIDTH - BALL_WIDHT):
...
class PongGame:
    ...
    def PlayNextMove(self, action):
        ...
        [score, self.ballXPos, self.ballYPos, self.ballXDirection, self.ballYDirection] = updateBall(self.paddle1YPos, self.paddle2YPos,
                                                                                                     self.ballXPos, self.ballYPos,
                                                                                                     self.ballXDirection,
                                                                                                     self.ballYDirection,
                                                                                                     DeltaFrameTime)
